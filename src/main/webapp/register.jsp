...
<html lang="en">
    ...
    <body>
        ...
        <main class="d-flex align-items-center temp-background mt-1 banner-background" style="height: 90vh;">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="RegisterServlet" id="myform" method="post">
                                  ...
                                  <div class="form-check">
                                   ...
                                   <%
                                        ...
                                        if(msg != null) {
                                   %>
                                            <p class="mt-2" style="text-align:center;"><%@include file="message.jsp" %></p>
                                   <%
                                        }
                                   %>
